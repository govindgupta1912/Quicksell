      ...
      <div className="ticket-column">
        <h3 className="column-top">
          ...
          <div className="column-icon">
              {columnTitle === "Backlog" && <img src={backlogicon} alt="" />}
              {columnTitle === "Todo" && <img src={todoicon} alt="" />}
              {columnTitle === "In Progress" && <img src={inprogicon} alt="" />}
              {columnTitle === "Completed" && <img src={doneicon} alt=""/>}
              {columnTitle === "Cancelled" && <img src={cancelledicon} alt=""/>}
            </div>
          <div>{columnTitle}</div>
